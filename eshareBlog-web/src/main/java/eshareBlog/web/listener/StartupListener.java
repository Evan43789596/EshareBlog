...
+---------------------------------------------------------------------------
*/
package eshareBlog.web.listener;

import eshareBlog.base.context.AppContext;
import eshareBlog.base.lang.Consts;
import eshareBlog.base.print.Printer;
import eshareBlog.base.utils.PropertiesLoader;
import eshareBlog.core.data.Config;
import eshareBlog.core.persist.service.ConfigService;
import eshareBlog.core.persist.service.FriendLinkService;
...
//						servletContext.setAttribute(conf.getKey(), conf.getValue());
				...
				Printer.info("OK, eshareBlog 加载完了");
            }
        }, 3 * Consts.TIME_MIN);
    }
