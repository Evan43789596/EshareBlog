var eshareBlog = function() {};
eshareBlog.browser = function() {
   ...
   return {//移动终端浏览器版本信息 
        ...
        android: u.indexOf('Android') > -1 && !eshareBlog.browser.linuxNotIsAndroid, //android终端或者uc浏览器
