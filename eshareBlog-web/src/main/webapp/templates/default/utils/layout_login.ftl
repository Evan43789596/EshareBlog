...
<head>
    ...
    <meta name="keywords" content="eshare,$!{site_keywords}">
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon-precomposed" href="http://eshare.com/assets/images/logo/m99.png"/>
    <link rel="shortcut icon" href="http://eshare.com/assets/images/logo/m.png"/>
