package eshareBlog.core.hook.interceptor.desk;

import eshareBlog.core.hook.interceptor.InterceptorHookSupport;
...
public class GroupVidewControllerHook extends InterceptorHookSupport {
    ...
    public String[] getInterceptor() {
        //说明要拦截的controller
        return new String[]{"eshareBlog.web.controller.desk.group.GroupVidewController"};
    }
